...
void MonomeSerialDevice::processSerial() {
    ...
    // 0x20 and 0x21 are for a Key inputs (grid) - see readKeys() function
        ...
        case 0x20:
            ...
            /*
            Serial1.print("grid key: ");
            Serial1.print(gridKeyX);
            Serial1.print(" ");
            Serial1.print(gridKeyY);
            Serial1.print(" up - ");
            */
            break;
